...
namespace MailNotifier
{
    ...
    public partial class FlatComboBox : ComboBox
    {
        ...
        // ==============================================================
        #region ==========  Переопределения свойств WinAPI  =============
        // ------------
        ...
        // ==================================== Переопределение структуры RECT
        /*------------*/
        ...
        // ==================================== Переопределение структуры PAINTSTRUCT
        /*------------*/
        [StructLayout(LayoutKind.Sequential)]
        // ------------ ------------
        ...
        // ==================================== Переопределение события BeginPaint
        /*------------*/
        [DllImport("user32.dll")]
        private static extern IntPtr BeginPaint(IntPtr hWnd, [In, Out] ref PAINTSTRUCT lpPaint);

        // ==================================== Переопределение события EndPaint
        /*------------*/
        [DllImport("user32.dll")]
        private static extern bool EndPaint(IntPtr hWnd, ref PAINTSTRUCT lpPaint);

        // ==================================== Переопределение события SelectClipRgn
        /*------------*/
        [DllImport("gdi32.dll")]
        public static extern int SelectClipRgn(IntPtr hDC, IntPtr hRgn);

        // ==================================== Переопределение перечисления RegionFlags
        /*------------*/
        [DllImport("user32.dll")]
        ...
        // ==================================== Переопределение события DeleteObject
        /*------------*/
        [DllImport("gdi32.dll")]
        internal static extern bool DeleteObject(IntPtr hObject);

        // ==================================== Переопределение события CreateRectRgn
        /*------------*/
        [DllImport("gdi32.dll")]
